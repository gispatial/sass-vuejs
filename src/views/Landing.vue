    ...
    >
      <div class="container mx-auto items-center flex flex-wrap">
        <div class="w-full md:w-8/12 lg:w-6/12 xl:w-6/12 px-4">
          ...
          <h2 class="font-semibold text-4xl text-gray-500">
            Enable Digital Onboarding</h2>
            <p class="mt-4 text-lg leading-relaxed text-gray-600">
            <b>SECURE · IMMUTABLE · IRREFUTABLE</b><br>
            Sign up with Xendity to access our API and SDK.
            Instantly enable your applications to onboard a customer securely.<div class="mt-12">
              <a
      ...
      <img src="https://saasdemo.xendity.com/assets/images/developer-image-banner.png" width="38%"  />
    </section>
          ...
          >
            ...
            >
              ...
              <blockquote class="relative p-8 mb-4">
                ...
                Get the Best Bank-Grade Electronic KYC Onboarding Solutions.
                </h4>
              ...
              <div class="w-full md:w-6/12 px-4">
                <div class="relative flex flex-col mt-4">
                  <div class="px-4 py-5 flex-auto">
                    ...
                    <p class="mb-4 text-gray-600">
                      Trusted by Financial Institution for best-in-class solutions
                    </p>
                  </div>
                </div>
                <div class="relative flex flex-col min-w-0">
                  <div class="px-4 py-5 flex-auto">
                    ...
                    <p class="mb-4 text-gray-600">Proven security and hosted in ISO 27701 and ISO 27018 compliant computing cloud for personal data protection.
                    </p>
                  </div>
                </div>
              </div>
              <div class="w-full md:w-6/12 px-4">
                <div class="relative flex flex-col min-w-0 mt-4">
                  <div class="px-4 py-5 flex-auto">
                    ...
                    <h6 class="text-xl mb-1 font-semibold">Flexible</h6>
                    <p class="mb-4 text-gray-600">Choose the most suitable plan from our cost-effective pay-per-use model and scale as you grow!</p>
                  </div>
                </div>
                <div class="relative flex flex-col min-w-0">
                  <div class="px-4 py-5 flex-auto">
      ...
      <div class="justify-center text-center flex flex-wrap mt-24">
        <div class="w-full md:w-6/12 px-12 md:px-4">
          ...
          <p class="text-lg leading-relaxed mt-4 mb-4 text-gray-600">
            XENDIT is a completly new product built using our past experience
